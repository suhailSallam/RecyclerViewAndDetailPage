...
//       connect the recyclerView with this adapter object
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Listitem  item = new Listitem("Hoe" ,
        ...
        listitems.add(item);
                ...
                , "US 10");
        listitems.add(item);
                item = new Listitem("Wheel Barrow"
                ...
                , "U$ 250");
        listitems.add(item);
                item = new Listitem("Concrete Mixer"
        ...
        listitems.add(item);
                ...
                , "U$ 15");
        listitems.add(item);
                item = new Listitem("Wooden Float/wooden rendering float"
                ...
                , "U$ 25");
        listitems.add(item);
                item = new Listitem("Torpedo Level"
